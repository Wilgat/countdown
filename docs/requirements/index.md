...
| `RQ-DOMAIN-COUNTDOWN` | requirement-domain-countdown | Named-countdown domain product law (duration, remaining time, storage, help/about domain rows) | domain | Active | `requirement-domain-countdown.md` | 2026-07-24 |
