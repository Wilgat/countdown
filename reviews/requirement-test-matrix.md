...
| **RQ-DOMAIN-COUNTDOWN** | requirement-domain-countdown | **PM-DOMAIN-TEST-PLAN** → **TP-COUNTDOWN** (no domain law mold) | **TP-COUNTDOWN-01..10** | `test_countdown_domain.sh` | **have** |
...
| **TP-CLI-05** shell storage fields | Domain owns storage (**TP-COUNTDOWN-09** private dir) |
