# =============================================================================
# tests/helpers.sh — shared assertions for countdown CI tests
# =============================================================================
# Source from test scripts (POSIX /bin/sh). Does not modify product code.
# Parameterized ship unit: APP_NAME (default countdown), SCRIPT, APP_VERSION.
# =============================================================================
...
# Remove this user's volatile countdown files (best-effort; domain suite).
...
# Back-compat alias if any suite still calls the timer name
