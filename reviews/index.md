...
|----|------|-------|--------|------|---------|
| plan-what-to-review | plan | Living product review checklist | Active | `what-to-review.md` | 2026-09-23 |
| plan-tests | test-plan | Portable TP families + domain TP-COUNTDOWN | Active | `test-plan.md` | 2026-09-23 |
| rtm-main | matrix | Requirement ↔ test matrix | Active | `requirement-test-matrix.md` | 2026-08-30 |
| lessons-main | lessons | Prior-report regression points | Active | `lessons.md` | 2026-09-23 |
...
| countdown | Revise | 0 | L-10 list JSON | 1.1.6 closes L-14 private cache leaf and L-15 `PROMPT_ASK_VALUE`; L-10 still open |

See `lessons.md` for durable regression checks; `test-plan.md` + `requirement-test-matrix.md` for CI lock-in (portable TP families **have**). 2026-09-23: **L-14** and **L-15** closed in 1.1.6 (private cache leaf mode 700; `prompt_ask` uses `PROMPT_ASK_VALUE`). **L-10** still open (`list --json` `timers` is a string-encoded array). Scoped report: `reports/2026-09-23-cache-and-capture-read.md`.
