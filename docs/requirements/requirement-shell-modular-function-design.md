...
This requirement is the **project Single Source of Truth** for **modular function organization** of the countdown POSIX shell CLI.
...
A modular-structure change for countdown is **not done** if any of the following fail:
